...
describe( 'validate', function tests() {
	...
	it( 'should return an error if provided a non-numeric `x0` parameter', function test() {
		var values, err;
		 values = [
			'5',
			[],
...
it( 'should return an error if provided a `gamma` parameter which is not a positive number', function test() {
		var values, err;
		 values = [
			-2,
			0,
